<template>
  <view class="uqrcode" :class="{ 'uqrcode-hide': hide }"
    ...
    <view class="uqrcode-canvas-wrapper">
    ...
    }" v-if="templateOptions.canvasDisplay" @tap="onClick"></canvas>
      <!-- #endif -->
      ...
      width: `${templateOptions.canvasWidth}px`,
      height: `${templateOptions.canvasHeight}px`
    }" v-if="templateOptions.canvasDisplay" @tap="onClick"></gcanvas>
      <!-- #endif -->
    </view>
    ...
    <!-- 错误处理 -->
    <view class="uqrcode-error" v-if="isError" @tap="onClick">
    ...
    <view class="uqrcode-h5-save" v-if="isH5Save">
      ...
      <view class="uqrcode-h5-save-close" @tap.stop="isH5Save = false">
