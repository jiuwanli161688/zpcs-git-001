 ...
 * 获取结算参数
 */
export function getCheckoutParams(params) {
  let url = "/trade/carts/checked?way=" + params.way + "&usePointFlag=" + params.usePointFlag
  if (params.usePoint) {
    url += "&usePoint=" + params.usePoint
  }
  return http.request({
    url: url,
    method: Method.GET,
...
export function getConfig() {
  return http.request({
    url: "/other/setting/miniProgramOpenSetting",
    method: Method.GET,
    needToken: true,
  });
}
