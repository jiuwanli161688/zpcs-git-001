<template>
	<view class="container">
		...
		<view class="list-content">
			<view class="item" v-for="(item, index) in filteredData" :key="index">
				<view class="row">
...
export default {
		...
		return {
			...
			arrData: [
                // Mock Data
				{
					flowNo: 'D2045024',
					orderNo: 'D2045024',
					merchantNo: '行政地区编码6位+2025+000000',
					amount: '100.00',
					pendingAmount: '100.00',
					time: '2025-10-28 20:30:48',
					status: '成功',
                    isSettled: false // Unsettled
				},
				{
					flowNo: 'D2045025',
					orderNo: 'D2045025',
					merchantNo: '行政地区编码6位+2025+000001',
					amount: '200.00',
					pendingAmount: '0.00',
				...
				},
                {
					flowNo: 'D2045026',
					orderNo: 'D2045026',
					merchantNo: '行政地区编码6位+2025+000002',
					amount: '150.00',
    ...
    computed: {
        filteredData() {
            // Filter based on curTab (0: Unsettled, 1: Settled)
            const isSettled = this.curTab === 1;
            return this.arrData.filter(item => item.isSettled === isSettled);
        }
    },
	methods: {
		handlerChange(index) {
