<template>
  <div class="feedBack">
    <div class="feedBack-box">
      <h4>猜你想问</h4>
      <div class="feedBack-item" :class="{ 'active': feedBack.type == item.value }" @tap="handleClick(index)"
    ...
    <div class="feedBack-box">
      <h4>问题反馈 <span style="margin-left:10rpx;" v-if="feedBack.type">@{{ list.find(item => {
          return item.value ==
            feedBack.type
        }).text }}</span></h4>
      ...
      <view class="opt-view">
        ...
        <view class="images-view">
          <u-upload :header="{ accessToken: storage.getAccessToken() }" :action="action" width="150"
            @on-uploaded="onUploaded" :max-count="2" :show-progress="false"></u-upload>
        </view>
      </view>
    </div>
