<template>
  <view class="person-msg">
    <view class="head c-content" @tap="changeFace">
    ...
    <u-form :model="form" ref="uForm" class="form">
      ...
      <u-form-item label="生日" label-width="150" right-icon="arrow-right">
        <u-input v-model="birthday" disabled placeholder="请选择出生日期" @tap="showBirthday = true" />
      ...
      <u-form-item label="城市" label-width="150" placeholder="请选择城市" right-icon="arrow-right">
        <u-input v-model="form.___path" disabled @tap="clickRegion" />
      </u-form-item>
      <view class="submit" @tap="submit">保存</view>
      <view class="submit" @tap="quiteLoginOut">退出登录</view>
    </u-form>
