	...
	<view class="myTracks">
		...
		<div v-else>
			<view v-if="item" v-for="(item, index) in trackList" :key="index">
				<view class="myTracks-title" v-if="item.storeName">{{ item.storeName }}
				</view>
				<view class="myTracks-items">

					<u-swipe-action style="width: 100%;" :show="item.show" :index="index" :key="item.id" @tap="delTracks"
						...
						<view v-else class="myTracks-item">
							<view class="myTracks-item-img" @tap.stop="navigateToDetail(item)">
								<image :src="item.thumbnail"></image>
							</view>
							<view class="myTracks-item-content" @tap.stop="navigateToDetail(item)">
