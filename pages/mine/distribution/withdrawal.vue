  ...
  <view>
    <view class="withdrawal-list">
      ...
      <view class="content">
        ...
        <view class="all">
          <view @tap="handleAll" :style="{ color: $mainColor }">全部</view>
          <view style="font-size: 24rpx; color: #999">可提现金额<span>{{ distributionData.canRebate | unitPrice }}</span>元
          </view>
        </view>
      </view>
    </view>

    <view class="submit" @tap="cashd">提现</view>
  </view>
</template>
<script>
