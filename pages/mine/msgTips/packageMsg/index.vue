	...
	<view class="container " style="font-size: 13px;">
		<block v-for="(row, index) in messageList" :key="index">
			<view class="msgItem">
				...
				<u-card @tap="goDetail(row.sn, row.logi_id, row.ship_no)" :title="title" title-color="#666666"
					title-size="24" sub-title-color="#666666" sub-title-size="24" :border="false" :sub-title=row.status>
