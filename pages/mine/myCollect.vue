			...
			<view v-if="tabCurrentIndex == 0" class="tab-content">
				<scroll-view class="list-scroll-content" scroll-y>
					...
					<u-swipe-action @open="openLeftChange(item, index, 'goods')" :show="item.selected" btn-width="180"
						...
						@tap="clickGoodsSwiperAction(item, index)" :index="index" :key="index">
						<view class="goods" @tap="goGoodsDetail(item)">
			...
			<view v-else class="tab-content">
				<scroll-view class="list-scroll-content" scroll-y>
					...
					<u-swipe-action @open="openLeftChange(item, 'store')" :show="item.selected" btn-width="180"
						...
						@tap="clickStoreSwiperAction(item)">
						<view class="store" @tap="goStoreMainPage(item.id)">
							<view class="intro">
								...
								<view class="store-name">
									...
									<u-tag size="mini" type="error" :color="$mainColor" v-if="item.selfOperated" text="中品严选"
										mode="plain" shape="circle" />
								</view>
