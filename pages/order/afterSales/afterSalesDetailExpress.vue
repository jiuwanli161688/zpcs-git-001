  ...
  <view class="mp-iphonex-bottom content">
    <u-form :model="form" ref="uForm">
      <view class="after-sales-goods-detail-view">
        ...
        <view>
          <view class="goods-item-view" @tap="gotoGoodsDetail(sku.skuId)">
      ...
      <scroll-view scroll-y>
        ...
        <view class="opt-view">
          ...
          <u-form-item label="快递公司" :label-width="150">
            <u-input v-model="form.courierCompany" type="select" input-align="right" :select-open="companySelectShow"
              @tap="companySelectShow = true" placeholder="请选择快递公司" />
          </u-form-item>
          ...
          <u-form-item label="发货时间" :label-width="150">
            <u-input input-align="right" type="selects" disabled v-model="form.mDeliverTime" @tap="timeshow = true"
              placeholder="请选择发货时间" />
          </u-form-item>
        </view>
      </scroll-view>
      ...
      <view class="submit-view">
        <u-button ripple :customStyle="{ 'background': $lightColor, 'color': '#fff' }" shape="circle"
          @tap="onSubmit">提交申请</u-button>
      </view>
    </u-form>
