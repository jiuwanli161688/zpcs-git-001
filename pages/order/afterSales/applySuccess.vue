<template>
  <view>
    <view class="header">
      ...
      <view class="btn-view">
        <view class="btn-item">
          <u-button ripple class="btn1" shape="circle" @tap="navigateToAfterSales()">查看记录</u-button>
        </view>
        <view class="btn-item">
          <u-button ripple class="btn2" shape="circle" @tap="navigateToHome()">回到主页</u-button>
        </view>
      </view>
    </view>
