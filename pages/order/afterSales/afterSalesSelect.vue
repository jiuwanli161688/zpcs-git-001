<template>
  <view>
    <view class="after-sales-goods-detail-view">
      ...
      <view>
        <view class="goods-item-view" :key="index" v-for="(item, index) in sku.orderItems" v-if="item.sn == sn"
          @tap="navigateToGoodsDetail(sku.skuId)">
    ...
    <view class="select-view">
      <view class="select-cell" v-if="applyInfo.returnGoods" @tap="onSelect(1)">
      ...
      <view class="select-cell" v-if="applyInfo.returnMoney" @tap="onSelect(3)">
        <view class="select-image">
