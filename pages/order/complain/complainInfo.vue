  ...
  <view class="wrapper">
    ...
    <u-cell-group>
      ...
      <view class="row" v-if="complainDetail.orderComplaintImages">
        <u-image width="100rpx" height="100rpx" border-radius="10" style="margin: 0 10rpx"
          v-for="(item, index) in complainDetail.orderComplaintImages" :key="index" :src="item"
          @tap="preview(complainDetail.orderComplaintImages, index)" />
      </view>
    </u-cell-group>
    ...
    <u-cell-group>
      ...
      <view class="row" v-if="complainDetail.appealImagesList">
        <u-image width="100rpx" height="100rpx" border-radius="10" style="margin: 0 10rpx"
          v-for="(item, index) in complainDetail.appealImagesList"
          @tap="preview(complainDetail.appealImagesList, index)" :key="index" :src="item" />
      </view>
    </u-cell-group>
