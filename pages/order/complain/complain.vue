<template>
  <view>
    ...
    <!-- 投诉模块 -->
    <view class="cell">
      <view class="cell-item between" @tap="complainShow = true">
      ...
      <view class="cell-item">
        ...
        <view class="cell-view">
          <u-upload ref="uUpload" :header="{ accessToken: storage.getAccessToken() }" :action="action" width="200"
            @on-uploaded="onUploaded" :max-count="5">
          </u-upload>
        </view>
      </view>
    </view>
