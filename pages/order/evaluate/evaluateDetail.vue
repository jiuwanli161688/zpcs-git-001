      ...
      <view class="member-view">
        <view class="member-img">
          <u-image width="82rpx" style="border: 1px solid #ededed" height="82rpx" shape="circle"
            :src="comment.memberProfile || userImage"></u-image>
        </view>
      ...
      <view class="goods-view">
        ...
        <view class="goods-imgs-view" v-if="comment.images != null && comment.images.length != 0">
          <view class="img-view" v-for="(img, imgIndex) in comment.images.split(',')" :key="imgIndex">
            <u-image @tap.native="preview(comment.images.split(','), imgIndex)" width="160rpx" height="160rpx"
              :src="img"></u-image>
          </view>
        </view>
        ...
        <view class="commentStyle" v-if="comment.reply">
          ...
          <view class="img">
            ...
            <u-image width="140rpx" height="140rpx" v-if="comment.replyImage"
              v-for="(replyImg, replyIndex) in splitImg(comment.replyImage)" :src="replyImg" :key="replyIndex"
              @tap="preview(splitImg(comment.replyImage), index)">
            </u-image>
          </view>
        </view>
      </view>
