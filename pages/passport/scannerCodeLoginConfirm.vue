      ...
      <div class="box">
        ...
        <div>
          <view class="small-tips flex flex-center">
            <u-image width="400rpx" height="300rpx"
              src="https://lili-system.oss-cn-beijing.aliyuncs.com/confirm.png"></u-image>
            <div>电脑端登录确认</div>
            <div>为确保帐号安全，请确认是您本人操作</div>
          </view>

          <view class="btns">
            <button @tap="confirmLogin()" class="btn-auth">确认登录</button>
            <div @tap="cancelLogin()" class="btn-callback">取消登录</div>
          </view>
        </div>
      </div>
    </view>
