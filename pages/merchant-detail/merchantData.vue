        ...
        <view class="data-manBody">
          <view class="frm-comm">
              ...
              <view class="flex">
                <picker mode="selector">
                  <view class="in-picker"
                    ><text class="text-xz">请选择</text></view
                  >
                </picker>
              </view>
            </view>
            ...
            <view class="rs rs-lines">
              ...
              <view class="txt flex">
                <view class="s-text s-texts" @tap="showPicker"
                  ><text class="text-xz">请选择</text>
                </view>
              </view>
            </view>
          </view>
