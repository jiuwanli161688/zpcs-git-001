<template>
  <div class="layout">
    <div class="view-width-100" @tap="modelNavigateTo(res.list[0])">
      <u-image class="image-mode" width="100%" height="200rpx" :src="res.list[0].img">
        <u-loading slot="loading"></u-loading>
      </u-image>
    </div>
    <div class="view-width-100" @tap="modelNavigateTo(res.list[1])">
      <div class="view-height-85">
        <u-image class="image-mode" width="100%" height="170rpx" :src="res.list[1].img">
          <u-loading slot="loading"></u-loading>
        </u-image>
      </div>
      <div class="view-height-85" @tap="modelNavigateTo(res.list[2])">
