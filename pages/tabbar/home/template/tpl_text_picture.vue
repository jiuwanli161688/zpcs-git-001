<template>
  <div class="layout">
    <div class="view-list">
      <div class="view-item" @tap="modelNavigateTo(res.list[0])">
      ...
      <div class="view-item" @tap="modelNavigateTo(res.list[1])">
    ...
    <div class="view-list">
      <div class="view-item" @tap="modelNavigateTo(res.list[2])">
      ...
      <div class="view-item" @tap="modelNavigateTo(res.list[3])">
