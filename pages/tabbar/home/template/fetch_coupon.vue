    ...
    <u-popup v-model="enableShowCoupon" mode="center" width="550rpx" height="400px">
      <view style="height: 130rpx">
        ...
        <view style="width: 120rpx; height: 120rpx; float: right">
          <image @tap="enableShowCoupon = false" src="/static/cpauto1.png" style="width: 100%; height: 100%"></image>
        </view>
      </view>
        ...
        <view v-for="(item, index) in coupList" :key="index">
          <view class="grad1">
            <view style="float: right">
              <view v-if="item.couponType == 'DISCOUNT'">{{ item.discount }}折</view>
              <view v-else>优惠金额：<span style="color: red; font-size: 32rpx">{{
