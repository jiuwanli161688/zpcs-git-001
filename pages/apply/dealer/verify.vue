<template>
    <view class="container" v-if="isComplete">
        ...
        <view>
            ...
            <view v-if="distributorStatus != '9'" class="lnk-common lnk-primary" @tap="handlerBack">返回上一步，重新填写信息</view>
        </view>
    </view>
</template>
...
export default {
    ...
    methods: {
        ...
        handlerSure: function () {
            getVerifyPrice(1).then(res => {
                if (res.data.code == 200) {
                    ...
                    if (res.data.result == 'IS_NOT_SIGNING') {
                        uni.navigateTo({
        ...
        handlerBack: function () {
            ...
            // uni.navigateTo({
            //     url: '/pages/apply/dealer/archives?source=' + this.source
            // })
        }
    },
