<template>
  <div class="wrapper">
    ...
    <div class="askBox" v-else>
      <u-row :gutter="24">
        <u-col span="2" @tap="goodsDetail()">
          <image class="img" :src="queryGoodsDetail.thumbnail"></image>
        </u-col>
        <u-col span="8" @tap="goodsDetail()">
        ...
        <u-col span="12">
          <u-row :gutter="12">
            <u-col :offset="1" span="4">
              <u-button class="btns" @tap="askValue = ''">清空</u-button>
            </u-col>
            <u-col :offset="2" span="4">
              <u-button class="btns" @tap="getAskMessage()" type="success">提交</u-button>
            </u-col>
          </u-row>
        </u-col>
      </u-row>
