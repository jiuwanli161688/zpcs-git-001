  ...
  <u-popup @close="close" v-model="show" mode="bottom" border-radius="30" height="260rpx">
    ...
    <view class="share-list">
      ...
      <view class="share-item">
        <button class="share-btn" @tap="weChatShare" open-type="share">
          <u-icon color="#04BE02" size="80" name="weixin-fill"></u-icon>微信好友
        </button>
      </view>
      <!-- #endif -->
      <!-- #ifdef APP-PLUS -->
      <view class="share-item" @tap="handleShare(item)" v-for="(item, index) in list" :key="index">
