		...
		return {
			...
			authList: {
				'WRITE_EXTERNAL_STORAGE': {
					title: "中品维度对存储空间/照片权限申请说明",
					content: "便于您使用该功能上传您的照片/图片/视频及用于更换头像、意见反馈、保存相册、下载与客服沟通等场景中读取和写入相册和文件内容。"
				},
				'ACCESS_FINE_LOCATION': {
					title: "中品维度对地理位置权限申请说明",
					content: "便于应用程序可以提供基于位置的服务、定位导航等功能。"
				},
				'CAMERA': {
					title: "中品维度对相机/摄像头权限申请说明",
					content: "便于您使用该功能拍照上传您的照片/视频及用于更换头像、意见反馈、保存相册、下载与客服沟通等场景中使用"
				},
				'RECORD_AUDIO': {
					title: "中品维度对麦克风权限申请说明",
					content: "便于您使用该功能进行录音、语音通话、与客服语音沟通等场景中使用"
				},
				'CALL_PHONE': {
					title: "中品维度对拨打/管理电话权限申请说明",
					content: "便于您使用该功能联系陪诊师，联系平台客服场景下使用"
				}
			}
		}
	},
		...
		requestPermissions(permissionID) {
			...
			if (plus.os.name == 'Android') {
				...
				if (permissionID == 'ACCESS_FINE_LOCATION') {
					...
					console.log(permissionID, '通讯录权限');
					//IOS检测通讯录权限
