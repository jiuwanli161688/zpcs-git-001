  ...
  <view class="serach">
    ...
    <view class="content" :style="{ 'border-radius': radius + 'px' }">
      ...
      <view class="content-box" :class="{ center: mode === 2 }">
        ...
        <u-icon name="close" v-if="isDelShow" style="padding:0 30rpx;" @tap="clear"></u-icon>
      </view>
    ...
    <view class="button active">
      ...
      <view v-else class="button-item">
        <u-icon name="grid-fill" size="50" @tap="handelListClass()" v-if="!switchLayout"></u-icon>
        <u-icon v-else @tap="handelListClass()" name="list-dot" size="50"></u-icon>
      </view>
    </view>
  </view>
</template>
...
export default {
  ...
  watch: {
    ...
    /**
     * 监听外部传入的value值变化，同步更新内部inputVal
     */
    value(newVal) {
