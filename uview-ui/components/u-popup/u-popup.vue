<template>
	<view v-if="visibleSync" :style="[customStyle, {
		...
		<u-mask :custom-style="maskCustomStyle" :maskClickAble="maskCloseAble" :z-index="uZindex - 2"
			:show="showDrawer && mask" @tap="maskClick"></u-mask>
		...
		zoom && mode == 'center' ? 'u-animation-zoom' : ''
			...
			<view class="u-mode-center-box" @tap.stop.prevent @touchmove.stop.prevent v-if="mode == 'center'"
				:style="[centerStyle]">
				<u-icon @tap="close" v-if="closeable" class="u-close" :class="['u-close--' + closeIconPos]"
